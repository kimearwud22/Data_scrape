...
#         URL = "https://www.lazada.co.id/{}".format(USERNAME)
...
#         FILE_NAME = 'lazada_{}.html'.format(USERNAME)
...
#         }
#         URL = "https://open.lazada.com/doc/api.htm?spm=a2o9m.11193487.0.0.1e4613fe7zgKsh#/api?cid=2&path=/seller"
...
#         URL = 'https://open.lazada.com/doc/api.htm?spm=a2o9m.11193487.0.0.1e4613fe7zgKsh#/api?cid=33&path=/review/seller/list'.format(
#             USERID
#         )
...
#         FILE_NAME = 'lazada_{}.json'.format(USERID)
#         with open(FILE_NAME, 'w') as file:
